...
export class ActivePicker extends React.Component {
    ...
    //پارامترهایی که باید دریافت شوند:
    //placeholder
    //name که در params ست می شود
    //values که یک ابجکت از داده ها برای نمایش در پیکر میباشند و باید بصورت
    //{{id:name,id1:name2,...}} باشد
    //changeValue متدی که مقداری که پیکر تغییر میکند را دریافت میکند...
        ...
        if (Platform.OS === 'ios') {
            return (
                <Picker
                    ...
                    itemStyle={{flexDirection: 'row-reverse', height: 100,}}
                    itemTextStyle={{textAlign: 'right', flexDirection: 'row-reverse'}}
                    textStyle={{textAlign: 'right'}}
                    placeholder={this.props.placeholder}
                    placeholderStyle={{color: "#bfc6ea"}}
                    placeholderIconColor="#007aff"
                    selectedValue={instance.state.params[this.props.name] + ''}
                    onValueChange={this.props.changeValue.bind(this)}
                    {...this.props}
                >
